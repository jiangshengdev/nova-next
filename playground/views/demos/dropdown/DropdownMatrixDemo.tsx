...
import { NovaButton, NovaColorPicker } from '@/index.ts'
        ...
        <div>
          ...
          <div class="demo-dropdown-matrix-placement">
            <div class="demo-dropdown-matrix-placement-top">
              <NovaButton onClick={() => setPlacement('topLeft')}>{() => 'Top Left'}</NovaButton>
              <NovaButton onClick={() => setPlacement('top')}>{() => 'Top'}</NovaButton>
              <NovaButton onClick={() => setPlacement('topRight')}>{() => 'Top Right'}</NovaButton>
            </div>
            <div class="demo-dropdown-matrix-placement-left">
              <NovaButton onClick={() => setPlacement('leftTop')}>{() => 'Left Top'}</NovaButton>
              <NovaButton onClick={() => setPlacement('left')}>{() => 'Left'}</NovaButton>
              <NovaButton onClick={() => setPlacement('leftBottom')}>
                {() => 'Left Bottom'}
              </NovaButton>
            </div>
            <div class="demo-dropdown-matrix-placement-right">
              <NovaButton onClick={() => setPlacement('rightTop')}>{() => 'Right Top'}</NovaButton>
              <NovaButton onClick={() => setPlacement('right')}>{() => 'Right'}</NovaButton>
            ...
            <div class="demo-dropdown-matrix-placement-bottom">
              ...
              <NovaButton onClick={() => setPlacement('bottom')}>{() => 'Bottom'}</NovaButton>
