    ...
    return () => (
      <div class="demo-input-styling">
        ...
        <div class="demo-input-group">
          <NovaInput wrapStyle={{ margin: '10px' }} placeholder="自定义 wrapStyle" />
          <NovaInput wrapClass="custom-wrap-class" placeholder="自定义 wrapClass" />
        </div>
        ...
        <div class="demo-input-description">
          <p>
            使用 <code>wrapClass</code> 和 <code>wrapStyle</code> 自定义外层容器样式， 使用{' '}
